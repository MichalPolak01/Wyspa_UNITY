...
public class MainMenuGUI : MonoBehaviour
{
    ...
    void OnGUI() {
        ...
        if (menuPage == "main") {
            ...
            GUI.Label(instructionsRect, "Obudziłeś się na tajemniczej wyspie...\n" + "Znajdź sposób na zwrócenie na siecie uwagi, inaczej zostaniesz tu na zawsze!");
    ...
    void Start()
    {
        ...
        playBtmRect = new Rect(50 * coefX, 250 * coefY, buttonWidth * coefX, buttonHeight * coefY);
